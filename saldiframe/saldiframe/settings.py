"""
Django settings for saldiframe project.
...
INSTALLED_APPS = [
    ...
    'dinarapp2.apps.Dinarapp2Config',
]
...
WSGI_APPLICATION = 'saldiframe.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db' / 'addresses.db',
    }
}


# Assumes you are using MySQL
# DATABASES = {
#     'default': {
...
# Настройка кэша
CACHE_MIDDLEWARE_SECONDS = 120  # В секундах
CACHE_MIDDLEWARE_KEY_PREFIX = 'tgbots'
